...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-stone-950 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 dark:focus-visible:ring-stone-300",
  {
    variants: {
      variant: {
        default:
          "bg-cyan-400 text-stone-50 shadow hover:bg-cyan-900/90 border-cyan-700 border-b-2 active:border-b-0",
        destructive:
          "bg-red-500 text-stone-50 shadow-sm hover:bg-red-500/90 dark:bg-red-900 dark:text-stone-50 dark:hover:bg-red-900/90",
        outline:
          "border border-stone-200 bg-white shadow-sm hover:bg-stone-100 text-stone-900 hover:text-stone-900 ",
        secondary:
          "bg-blue-400 text-neutral-100 shadow-sm hover:bg-blue-400/80 border-blue-900 border-b-2 active:border-b-0",
        ghost: "hover:bg-stone-100 hover:text-stone-900 dark:hover:bg-stone-800 dark:hover:text-stone-50",
        link: "text-stone-900 underline-offset-4 hover:underline dark:text-stone-50",
        sidebar: "text-slate-600 font-bold bg-transparent hover:bg-transparent border-transparent border-0",
        sidebarActive: "text-sky-500 font-bold bg-sky-500/10 hover:bg-sky-500/25  border-transparent border-sky-300",
      },
      size: {

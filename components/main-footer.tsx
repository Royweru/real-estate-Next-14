...
export const Footer= (props: Footer1Props) => {
  ...
  return (
    <footer id="relume" className="px-[5%] py-12 md:py-18 lg:py-20 border-t border-gray-700">
      <div className="container">
        <div className="grid grid-cols-1 gap-x-[8vw] gap-y-12 pb-12 md:gap-y-16 md:pb-18 lg:grid-cols-[0.75fr_1fr] lg:gap-y-4 lg:pb-20">
          <div className="flex flex-col">
            <a href={logo.url} className="mb-5 md:mb-6">
              <img src={logo.src} alt={logo.alt} className="inline-block"  width={55} height={60}/>
            </a>
...
export const Footer1Defaults: Props = {
  ...
  footerText: "© 2025 Apartamenti. All rights reserved.",
  footerLinks: [

...
export const Hero = ({
  ...
  return (
    <div className='relative w-full min-h-screen bg-[url("/hero3.jpg")] bg-center bg-cover'>
      ...
      <div className='relative z-10 flex flex-1 flex-col items-center justify-center px-4 pb-16'>
        <div className='flex flex-col items-center space-y-3 w-full text-center max-w-3xl'>
          <p className='lg:font-semibold font-medium text-base capitalize text-violet-300 hero-subheader'>
            Kenya&apos;s trusted property marketplace
          </p>
          <h3 className='md:text-5xl font-bold leading-tight text-white text-3xl hero-header'>
        ...
        <div className='mt-10 flex flex-wrap items-center justify-center gap-4 md:gap-8 rounded-full bg-white/10 px-6 py-3 backdrop-blur-md ring-1 ring-white/20'>

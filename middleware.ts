...
import { apiAuthPrefix,authRoute,DEFAULT_LOGIN_REDIRECT, publicRoutes,listingViewRoute } from "./routes";
...
export default auth((req): void | Response | Promise<void | Response> => {
  ...
  const isListingView= nextUrl.pathname.startsWith(listingViewRoute)
